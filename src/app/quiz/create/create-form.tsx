...
export default function CreateForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Label>Content</Label>
      <Input
        placeholder="Enter the question... eg, Who created education?"
        {...register("content")}
      />
      ...
      <div
        className="sm:w-full flex sm:flex-row flex-col sm:items-start sm:justify-between gap-4 sm:gap-2
            "
      >
                          ...
                          topics.map((topic) => (
                            <CommandItem
                              ...
                              onSelect={(currentValue: string) => {
                                field.onChange(
                                  topics.find((t) => t.name === currentValue)
                                    ?.id!
                                );
        ...
        <div className="flex flex-col w-full">
          <Label className="mb-1 block">Select Article (Optional)</Label>
          ...
          {sections.length > 0 && (
            ...
            >
              <Label className="mb-1 block">
                Select Article Section (Optional)
              </Label>
              <Controller
                control={control}
                name="articleSection"
      ...
      <div className="mt-3">
        ...
        {errors.correctOption && (
          <ErrorText text={errors.correctOption.message!} />
        )}
      ...
      {formData && (
        <ConfirmDialog formData={formData!} isDialogOpen={isDialogOpen} />
      )}
    </form>
  );
}
